...
<body>
	...
	<div class="container">
        ...
        <p class="login-text" style="font-size: 2rem; font-weight: 800;">Login with social media</p>
		...
		<form action="" method="POST" class="login-email">
			...
			<p class="login-register-text">Have an account? <a href="indexlogin.php">Login Here</a>.</p>
		</form>
	</div>
</body>
</html>
